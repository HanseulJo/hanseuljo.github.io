var store = [{
        ...
        "excerpt":"  Main References      Albert No, Taeho Yoon, Sehyun Kwon, and Ernest K. Ryu. WGAN with an Infinitely Wide Generator Has No Spurious Stationary Points. ICML 2021.  ","categories": ["paper review","group meeting"],
        ...
        "excerpt":"  Main References      Ilya Kostrikov, Ashvin Nair, and Sergey Levine. Offline Reinforcement Learning with Implicit Q Learning. ICLR 2022.  ","categories": ["paper review","coursework"],
        ...
        "excerpt":"  Main References      Changjian Shui, Gezheng Xu, Qi CHEN, Jiaqi Li, Charles Ling, Tal Arbel, Boyu Wang, and Christian Gagné. On Learning Fairness and Accuracy on Multiple Subgroups. NeurIPS 2022.  ","categories": ["paper review","group meeting"],
        ...
        "excerpt":"  Main References      Fabian Latorre, Igor Krawczuk, Leello Tadesse Dadi, Thomas Pethick, and Volkan Cevher. Finding Actual Descent Directions for Adversarial Training. ICLR 2023.   Aleksander Madry, Aleksandar Makelov, Ludwig Schmidt, Dimitris Tsipras, and Adrian Vladu Towards Deep Learning Models Resistant to Adversarial Attacks. ICLR 2018.  ","categories": ["paper review","group meeting"],
        ...
        "excerpt":"  Main References      Arthur Jacot. Implicit Bias of Large Depth Networks: a Notion of Rank for Nonlinear Functions. ICLR 2023.  ","categories": ["paper review","group meeting"],
        ...
        "excerpt":"Abstract In this report, we briefly overview the theory of optimal transport (OT),entropically regularized OT and Sinkhorn algorithm, and their application to deep learning model fusion technique. For the theory of OT, we delve into the derivation of dual OT problem and the proof of no duality gap result (i.e.,...","categories": ["coursework","report"],
        ...
        "excerpt":"  Main References      Sanjeev Arora, Zhiyuan Li, and Abhishek Panigrahi. Understanding Gradient Descent on Edge of Stability in Deep Learning. ICML 2022.  ","categories": ["paper review","group meeting"],
        ...
        "excerpt":"  Main References      Haochuan Li, Jian Qian, Yi Tian, Alexander Rakhlin, and Ali Jadbabaie. Convex and Non-convex Optimization under Generalized Smoothness. NeurIPS 2023.  ","categories": ["paper review","group meeting"],
        ...
        "excerpt":"  Main References      Shida Wang and Qianxiao Li. StableSSM: Alleviating the Curse of Memory in State-space Models through Stable Reparameterization. ICML 2024.  ","categories": ["paper review","group meeting"],
        ...
        "excerpt":"Read the Full Document    ","categories": ["thesis proposal","research proposal"],
        "tags": ["Ph.D.","PhD"],
