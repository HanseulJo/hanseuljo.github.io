var store = [{
        ...
        "excerpt":" For mobile: View PDF   Main References      Albert No, Taeho Yoon, Sehyun Kwon, and Ernest K. Ryu. WGAN with an Infinitely Wide Generator Has No Spurious Stationary Points. ICML 2021.  ","categories": ["paper review","group meeting"],
        ...
        "excerpt":" For mobile: View PDF   Main References      Ilya Kostrikov, Ashvin Nair, and Sergey Levine. Offline Reinforcement Learning with Implicit Q Learning. ICLR 2022.  ","categories": ["paper review","coursework"],
        ...
        "excerpt":" For mobile: View PDF   Main References      Changjian Shui, Gezheng Xu, Qi CHEN, Jiaqi Li, Charles Ling, Tal Arbel, Boyu Wang, and Christian Gagné. On Learning Fairness and Accuracy on Multiple Subgroups. NeurIPS 2022.  ","categories": ["paper review","group meeting"],
        ...
        "excerpt":" For mobile: View PDF   Main References      Fabian Latorre, Igor Krawczuk, Leello Tadesse Dadi, Thomas Pethick, and Volkan Cevher. Finding Actual Descent Directions for Adversarial Training. ICLR 2023.   Aleksander Madry, Aleksandar Makelov, Ludwig Schmidt, Dimitris Tsipras, and Adrian Vladu Towards Deep Learning Models Resistant to Adversarial Attacks. ICLR 2018.  ","categories": ["paper review","group meeting"],
        ...
        "excerpt":" For mobile: View PDF   Main References      Arthur Jacot. Implicit Bias of Large Depth Networks: a Notion of Rank for Nonlinear Functions. ICLR 2023.  ","categories": ["paper review","group meeting"],
        ...
        "excerpt":"For mobile: View PDF Abstract In this report, we briefly overview the theory of optimal transport (OT),entropically regularized OT and Sinkhorn algorithm, and their application to deep learning model fusion technique. For the theory of OT, we delve into the derivation of dual OT problem and the proof of no...","categories": ["coursework","report"],
        ...
        "excerpt":" For mobile: View PDF   Main References      Alicia Curth, Alan Jeffares, and Mihaela van der Schaar. A U-turn on Double Descent: Rethinking Parameter Counting in Statistical Learning. NeurIPS 2023.   Mikhail Belkin, Daniel Hsu, Siyuan Ma, and Soumik Mandal. Reconciling modern machine-learning practice and the classical bias–variance trade-off. PNAS 2019.  ","categories": ["paper review","group meeting"],
        ...
        "excerpt":" For mobile: View PDF   Main References      Sanjeev Arora, Zhiyuan Li, and Abhishek Panigrahi. Understanding Gradient Descent on Edge of Stability in Deep Learning. ICML 2022.  ","categories": ["paper review","group meeting"],
        ...
        "excerpt":" For mobile: View PDF   Main References      Haochuan Li, Jian Qian, Yi Tian, Alexander Rakhlin, and Ali Jadbabaie. Convex and Non-convex Optimization under Generalized Smoothness. NeurIPS 2023.  ","categories": ["paper review","group meeting"],
        ...
        "excerpt":" For mobile: View PDF   Main References      Shida Wang and Qianxiao Li. StableSSM: Alleviating the Curse of Memory in State-space Models through Stable Reparameterization. ICML 2024.  ","categories": ["paper review","group meeting"],
        ...
        "excerpt":" For mobile: View PDF   Main References      Clayton Sanford, Danial Hsu, and Matus Telgarsky. Transformers, Parallel Computation, and Logarithmic Depth. ICML 2024.   Clayton Sanford, Bahare Fatemi, Ethan Hall, Anton Tsitsulin, Mehran Kazemi, Jonathan Halcrow, Bryan Perozzi, and Vahab Mirrokni. Understanding Transformer Reasoning Capabilities via Graph Algorithms. NeurIPS 2024.  ","categories": ["paper review","group meeting"],
        ...
        "excerpt":"Read the Full Document (PC recommended)    ","categories": ["thesis proposal","research proposal"],
        "tags": ["Ph.D.","PhD"],
